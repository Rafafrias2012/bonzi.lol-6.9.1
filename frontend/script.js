    ...
    var passcode = "";
    var err = false;
    var ignorehtml = ["b", "i", "u", "s", "font size=5", "div", "div class='quote'", "h5", "marquee"];
    var emotes = [{
        name: "cool",
        action: [{
            type: "anim",
    ...
    function loadBonzis(a) {
        loadQueue.loadManifest([{
                ...
                id: "bonziSeamus",
                src: "./img/bonzi/seamus.png"
            }, {
                id: "bonziJabba",
                src: "./img/bonzi/jabba.png"
            }, {
                id: "bonziJew",
                src: "./img/bonzi/jew.png"
            }, {
                id: "bonziOrange",
                src: "./img/bonzi/orange.png"
            }, {
                id: "bonziDress",
                src: "./img/bonzi/dress.png"
            }, {
                id: "bonziFloyd",
                src: "./img/bonzi/floyd.png"
            }, {
                id: "bonziInverted",
                src: "./img/bonzi/inverted.png"
            }, {
                id: "bonziRonnie",
                src: "./img/bonzi/ronnie.png"
            }, {
                id: "bonziBlessed",
                src: "./img/bonzi/blessed.png"
            }, {
                id: "bonziAllah",
                src: "./img/bonzi/allah.png"
            }, {
                id: "topjej",
    ...
    function sendInput() {
        ...
        if (($("#chat_message").val(""), a.length > 0)) {
            ...
            if (b) return void socket.emit("command", {
                list: ["youtube", b]
            });
            if ("/" == a.substring(1, 0)) {
    ...
    var _createClass = (function() {
        ...
        Bonzi = (function() {
            ...
            return (
                _createClass(a, [{
                    ...
                    key: "mousedown",
                    value: function(a) {
                        1 == a.which && ((this.drag = !0), (this.dragged = !1), (this.drag_start = {
                            x: a.pageX - this.x,
                            y: a.pageY - this.y
                        }));
                    },
                    ...
                    value: function(a) {
                        if (!this.mute) {
                            ...
                            this.$dialogCont.html(
                                    "\n\t\t\t\t\t<" +
                                    b +
                                    ' type="text/html" width="173" height="173" \n\t\t\t\t\tsrc="https://web.archive.org/web/20230215220207/https://www.youtube.com/embed/' +
                                    a +
        ...
        BonziData = {
            ...
            event_list_joke_open: [
                ...
                [{
                    type: "text",
                    text: "Prepare for something Seamus never heard of"
                }, {
                    type: "anim",
                    anim: "praise_fwd",
                    ticks: 15
                ...
                [{
                    type: "text",
                    text: "{NAME} asked me for jewish comedy."
                }],
                [{
                    type: "text",
            ...
            event_list_joke_mid: [
                ...
                [{
                    type: "text",
                    text: "How many arabs does it take to knock down a lightbulb?"
                }, {
                    type: "text",
                    text: "I don't know but just a few can knock down 2 towers."
                }, ],
                [{
                    type: "text",
                    text: "What do you call an autistic child with herpes?"
                }, {
                    type: "text",
                ...
                [{
                    ...
                    type: "text",
                    text: "I don't know but jews are probably to blame."
                }, ],
                [{
                    type: "text",
                ...
                [{
                    type: "text",
                    text: "How do you get a girlfriend?"
                }, {
                    type: "text",
                    text: "You rape one"
                }, {
            ...
            event_list_fact_mid: [
                ...
                [{
                    ...
                    type: "text",
                    text: "Gay faggots have no rights. Pride month isn't real."
                }, {
                    type: "anim",
                    anim: "earth_back",
                    ticks: 15
                ...
                [{
                    ...
                    type: "text",
                    text: "The jews did everything that's bad."
                }, {
                    type: "anim",
                    anim: "earth_back",
                    ticks: 15
